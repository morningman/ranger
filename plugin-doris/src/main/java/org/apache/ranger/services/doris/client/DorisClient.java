...
public class DorisClient extends BaseClient implements Closeable {
  ...
  private void initConnection() {
    ...
    properties.put(USER_NAME_PROP, prop.getProperty(HadoopConfigHolder.RANGER_LOGIN_USER_NAME_PROP));
    if (prop.getProperty(HadoopConfigHolder.RANGER_LOGIN_PASSWORD) != null) {
      properties.put(PASSWORD_PROP, prop.getProperty(HadoopConfigHolder.RANGER_LOGIN_PASSWORD));
    }
  ...
  public List<String> getCatalogList(String needle, final List<String> catalogs) throws HadoopException {
    ...
    List<String> ctls = Subject.doAs(getLoginSubject(), new PrivilegedAction<List<String>>() {
      @Override
      public List<String> run() {
        ...
        try {
          ...
          LOG.error("<== DorisClient.getCatalogList() :Unable to get the Catalog List", he);
          throw he;
        }
        return ret;
      }
    ...
    if (con != null) {
      ...
      try {
        ...
        if (LOG.isDebugEnabled()) {
          LOG.debug("<== DorisClient.getSchemas() Error : ", sqlt);
        }
        throw hdpException;
        ...
        hdpException.generateResponseDataMap(false, getMessage(sqle),
          msgDesc + ERR_MSG, null, null);
        if (LOG.isDebugEnabled()) {
          LOG.debug("<== DorisClient.getSchemas() Error : ", sqle);
        }
        throw hdpException;
      }
    }
    ...
    List<String> schemaList = Subject.doAs(getLoginSubject(), new PrivilegedAction<List<String>>() {
      ...
      public List<String> run() {
        ...
        try {
          ...
          LOG.error("<== DorisClient.getSchemaList() :Unable to get the Schema List", he);
        }
        return ret;
      }
    });
      ...
      if (catalogs != null && !catalogs.isEmpty()
        ...
        try {
          ...
          hdpException.generateResponseDataMap(false, getMessage(sqlt),
            msgDesc + ERR_MSG, null, null);
          if (LOG.isDebugEnabled()) {
            LOG.debug("<== DorisClient.getTables() Error : ", sqlt);
          }
          throw hdpException;
        } catch (SQLException sqle) {
          String msgDesc = "Unable to execute SQL [" + sql + "].";
          ...
          hdpException.generateResponseDataMap(false, getMessage(sqle),
            msgDesc + ERR_MSG, null, null);
          if (LOG.isDebugEnabled()) {
            LOG.debug("<== DorisClient.getTables() Error : ", sqle);
          }
          throw hdpException;
        }
      }
    ...
    List<String> tableList = Subject.doAs(getLoginSubject(), new PrivilegedAction<List<String>>() {
      ...
      public List<String> run() {
        ...
        try {
          ...
          LOG.error("<== DorisClient.getTableList() :Unable to get the Column List", he);
          throw he;
        }
        return ret;
      }
      ...
      if (catalogs != null && !catalogs.isEmpty()
        ...
        try {
          ...
          hdpException.generateResponseDataMap(false, getMessage(sqlt),
            msgDesc + ERR_MSG, null, null);
          if (LOG.isDebugEnabled()) {
            LOG.debug("<== DorisClient.getColumns() Error : ", sqlt);
          }
          throw hdpException;
        } catch (SQLException sqle) {
          String msgDesc = "Unable to execute SQL [" + sql + "].";
          ...
          hdpException.generateResponseDataMap(false, getMessage(sqle),
            msgDesc + ERR_MSG, null, null);
          if (LOG.isDebugEnabled()) {
            LOG.debug("<== DorisClient.getColumns() Error : ", sqle);
          }
          throw hdpException;
        }
      }
    ...
    List<String> columnList = Subject.doAs(getLoginSubject(), new PrivilegedAction<List<String>>() {
      ...
      public List<String> run() {
        ...
        try {
          ...
          LOG.error("<== DorisClient.getColumnList() :Unable to get the Column List", he);
          throw he;
        }
        return ret;
      }
  ...
  public List<String> getResourceList(String needle, List<String> finalResourceList) {
    ...
    List<String> res = Subject.doAs(getLoginSubject(), new PrivilegedAction<List<String>>() {
      @Override
      public List<String> run() {
        List<String> ret = null;
        try {
          ret = getResources(ndl, resourceList);
        } catch (HadoopException he) {
          LOG.error("<== DorisClient.getResourceList() :Unable to get the Resource List", he);
          throw he;
        }
        return ret;
      }
    ...
    if (con != null) {
      ...
      try {
        ...
        while (rs.next()) {
          ...
          if (resourceList != null && resourceList.contains(resourceName)) {
            continue;
          }
  ...
  public List<String> getWorkloadGroupList(String needle, List<String> finalWorkloadGroupList) {
    ...
    List<String> res = Subject.doAs(getLoginSubject(), new PrivilegedAction<List<String>>() {
      ...
      public List<String> run() {
        List<String> ret = null;
        try {
          ret = getWorkloadGroup(ndl, workloadGroupList);
        } catch (HadoopException he) {
          LOG.error("<== DorisClient.getWorkLoadGroupList() :Unable to get the WorkloadGroup List", he);
          throw he;
        }
        return ret;
      }
    ...
    if (con != null) {
      ...
      try {
        ...
        while (rs.next()) {
          ...
          if (workloadGroupList != null && workloadGroupList.contains(wgName)) {
            continue;
          }
          ret.add(wgName);
        }
